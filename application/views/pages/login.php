            ...
            <div class="login-panel panel panel-success">
              ...
              $error_msg= $this->session->flashdata('error_msg');
                ...
                <div class="panel-body">
                    <form role="form" class="p-3" method="post" action="<?php echo base_url('user/login_user'); ?>">
                        <fieldset>
                ...
                <center><b>You are not registered ?</b> <br></b><a href="<?php echo base_url('register'); ?>">Register here</a></center><!--for centered text-->
