...
<form class="" method="post" action="<?php echo base_url('admin/product/store'); ?>" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="status" name="status" class="input-file" type="checkbox">
  </div>
</div>
